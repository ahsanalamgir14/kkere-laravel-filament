...
<?php $component->withAttributes(['placement' => 'bottom-end']); ?>
             <?php $__env->slot('trigger', null, []); ?> 
                    <button type="button" aria-label="<?php echo e(__('messages.t_aria_label_language_switcher')); ?>">
                    <div class="flex items-center gap-x-1" tabindex="0">
                        <div class="flex items-center gap-x-2">
                        <!--[if BLOCK]><![endif]--><?php if(!is_null($icon)): ?>
                        <img src="<?php echo e($icon); ?>" alt="" class="w-7 rounded-sm h-5">
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        <?php echo e($default_title); ?>

                    </div>
                        <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('icon-arrow-down-3'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(BladeUI\Icons\Components\Svg::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-4 h-4 dark:text-gray-500']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.dropdown.list.index','data' => ['role' => 'menu']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['role' => 'menu']); ?>
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = fetch_active_languages(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.dropdown.list.item','data' => ['role' => 'menuitem','tabindex' => '0','wire:key' => 'switch-'.e($lang->lang_code).'','wire:click' => 'updateLocale(\''.e($lang->lang_code).'\')','@click' => '$refs.panel.close(event); ']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['role' => 'menuitem','tabindex' => '0','wire:key' => 'switch-'.e($lang->lang_code).'','wire:click' => 'updateLocale(\''.e($lang->lang_code).'\')','@click' => '$refs.panel.close(event); ']); ?>
                    <div class="flex justify-between" >
                        <div class="flex items-center gap-x-2">
                            <!--[if BLOCK]><![endif]--><?php if($lang->icon): ?>
                            <img src="<?php echo e(\Storage::url($lang->icon)); ?>" alt="" class="w-7 rounded-sm h-5">
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            <?php echo e($lang->title); ?>

                        </div>
                        <!--[if BLOCK]><![endif]--><?php if($default_lang_code === $lang->lang_code): ?>
                            <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php /**PATH C:\xampp\htdocs\kkere\resources\views/livewire/partials/language-switcher.blade.php ENDPATH**/ ?>