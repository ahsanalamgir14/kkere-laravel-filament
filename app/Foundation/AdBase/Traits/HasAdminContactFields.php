...
trait HasAdminContactFields
{
     ...
     */
    public static function getDisplayPhoneToggle()
    {
     ...
     * @return PhoneInput
     */
    public static function getPhoneNumberInput()
    {
     ...
     * @return ToggleButtons
     */
    public static function getSameNumberToggle()
    {
        return ToggleButtons::make('display_whatsapp')
            ...
            ->afterStateUpdated(function ($state, Get $get, Set $set) {
                ...
                if ($state) {
                    ...
                    // $this->ad->save();
                    // $this->checkRequiredFieldsFilled();
                    $set('whatsapp_number', $get('whatsapp_number'));
                }
            })
            ->live()
            ->boolean()
     ...
     * @return PhoneInput
     */
    public static function getWhatsappNumberInput()
    {
